...
class MyGUI:
    ...
    def __init__(self):
        ...
        button_1 = tk.Button(buttonframe, text="Stop Application", 
        ...
        command= self.gui_remove_from_list)
    ...
    def search_list(self):
        ...
        self.ok_button = tk.Button(self.labelframe, text="Search", 
    ...
    def start_search(self):
        ...
        """Checks if user input is in list and within character limit"""
        if 1 <= len(self.user_in) <= 25 :
        
            if self.user_in in fruits_and_vegetables:
                print("Found item")
                label2 = tk.Label(self.labelframe, 
                text="Found item: " + str(self.user_in))
                label2.pack()
        ...
        if  self.user_in == "":
            label = tk.Label(self.labelframe,
            text="There is nothing to search with")
            label.pack()
        
        if len(self.user_in) >= 26:
            in_char = tk.Label(self.labelframe, 
            text= "Incorrect amount of characters")
            in_char.pack()

        self.input_field.destroy()
        self.ok_button.destroy()
            
    """Sorts list alphabetically and displays it"""
    def sort_list(self):
    ...
    def add_to_list(self):
        ...
        self.ok_button = tk.Button(self.labelframe, 
        text="Add item", command= self.append_list)
        self.ok_button.pack()

    """Adds element to list if input is only letters and within char limit"""
    ...
    def gui_remove_from_list(self):
        ...
        self.delete_button = tk.Button(self.labelframe,
        text="Delete",command = self.remove_from_list)
        self.delete_button.pack()

    """Removes element from list if it is in list and within char lim"""
    def remove_from_list(self):
        ...
        if 1 <= len(to_remove) <= 25:
            if to_remove in fruits_and_vegetables:
                ...
                in_list = tk.Label(self.labelframe, 
    ...
    """Clears labelframe, 
    used at the start of every function if labelframe =! empty"""
